...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'WatchGeek', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '手表极客🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tw.WatchGeek.cc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '手表极客WatchGeek', // 网站关键词 英文逗号隔开
